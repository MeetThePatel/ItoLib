use crate::float::{
    FiniteFloat, IntoFloat, NonNegativeFiniteFloat, NonNegativeFloat, PositiveFloat,
};
use crate::{generate_infallible_conversion_impls, impl_float};
...
#[derive(Debug)]
#[derive(Copy, Clone)]
pub struct PositiveFiniteFloat(f64);
...
impl IntoFloat for PositiveFiniteFloat {
    fn as_f64(&self) -> f64 {
        self.0
    }
}
